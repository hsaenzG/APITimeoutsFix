...
```bash
APITimeoutsFix$ sam logs -n StockCheckerFunction --stack-name APITimeoutsFix --tail
```
...
```bash
APITimeoutsFix$ cd functions/stock-checker
...
```bash
sam delete --stack-name APITimeoutsFix
```
